...
//!
//! Saving a *named* bundle (overwriting one of the same name) is done by the
//! TUI `edit::EditScreen::save_to_library`; this module owns the shared
