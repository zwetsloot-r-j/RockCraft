...
//   core::NoteSpan is (pitch: u8, start_us, end_us) in MICROSECONDS with no
//   hand. This screen's NoteSpan is { note, start, end, hand } in MILLISECONDS.
//   #168 converts at the boundary (us → ms, derive/ignore hand) instead of
//   editing the engine, so the engine stays the prototype's exact projection.
